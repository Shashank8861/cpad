...
class AppStateNotifier extends ChangeNotifier {
  HiireFirebaseUser? initialUser;
  HiireFirebaseUser? user;
  ...
  void update(HiireFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'viewCustomer',
              path: 'viewCustomer',
              builder: (context, params) => ViewCustomerWidget(
                userid: params.getParam('userid', ParamType.String),
                jobid: params.getParam('jobid', ParamType.String),
                jobName: params.getParam('jobName', ParamType.String),
                userdp: params.getParam('userdp', ParamType.String),
                requesterName:
                    params.getParam('requesterName', ParamType.String),
                requesterRef: params.getParam('requesterRef',
                    ParamType.DocumentReference, false, 'interested'),
                accepterId: params.getParam('accepterId', ParamType.String),
                jobStatus: params.getParam('jobStatus', ParamType.String),
            ...
            FFRoute(
              name: 'requesters',
              path: 'requesters',
              builder: (context, params) => RequestersWidget(),
            ),
            FFRoute(
              name: 'addjob',
              path: 'addjob',
